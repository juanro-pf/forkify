...
class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    ['hashchange', 'load'].forEach(ev => window.addEventListener(ev, handler)); // This is here and not in the controller due to the publisher subscriber design pattern
  }
...
export default new RecipeView(); // To avoid having multiple RecipeViews, which does not make sense